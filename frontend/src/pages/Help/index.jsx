...
const Help = () => {
  ...
  // 常见问题数据
  const faqData = [
    { key: '1', question: '如何上传数据集？', answer: '在主页点击"上传数据"按钮，选择您要上传的数据文件。支持CSV、JSON、TXT等格式。文件大小限制为100MB。' },
    { key: '2', question: '训练模型需要多长时间？', answer: '训练时间取决于数据集大小、模型复杂度和硬件配置。通常小型数据集（<1GB）需要10-30分钟，大型数据集可能需要数小时。' },
    { key: '3', question: '如何查看训练进度？', answer: '在"训练记录"页面可以实时查看所有训练任务的进度、状态和详细日志信息。' },
