...
const Help = () => {
  ...
  // 常见问题数据
  const faqData = [
    { key: '1', question: '如何上传数据集？', answer: '在首页点击"上传数据"按钮，选择您要上传的数据文件。支持lerobot数据集，ZIP格式，大小不超过500MB。' },
    { key: '2', question: '训练模型需要多长时间？', answer: '训练时间取决于参数配置中的steps大小、模型复杂度和硬件配置。' },
    { key: '3', question: '如何查看训练进度？', answer: '在"项目详情"页面可以实时查看训练项目的进度、Loss图表和详细日志信息。' },
    { key: '4', question: '支持哪些模型类型？', answer: '目前支持ACT模型和Diffusion模型' }, 
    { key: '5', question: '如何导出训练结果？', answer: '训练完成后，在项目详情页面点击"下载"按钮，可以下载训练生成的模型文件' },
    { key: '6', question: '如何评估训练结果？', answer: '训练完成后，在评估项目页面点击"发起评估"部分，可以对已完成的训练项目进行评估' },
    { key: '7', question: '如何查看评估结果？', answer: '评估完成后，在评估项目页面的左侧选择栏中，点击评估项目，可以查看对应评估结果' },
    { key: '8', question: '如何导出评估结果？', answer: '在评估项目页面点击"下载"按钮，可以下载评估生成的视频文件' },
  ];
